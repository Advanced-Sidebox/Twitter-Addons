!function () {
	Function && Function.prototype && Function.prototype.bind && (/MSIE [678]/.test(navigator.userAgent) || (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded && window.twttr.widgets.load && window.twttr.widgets.load(), window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init || !function (t) {
			...
			([function (t, e, n) {
						...
						v(),
						r = new i,
						s.exposeReadyPromise(r.promise, a.base, g),
						a.set("widgets", h),
						...
						(function (t) {
							...
							(function () {
								...
								function m() {
									try {
										var t = n(5);
										return W = t.runOnLoop || t.runOnContext,
										d()
									} catch (t) {
										return h()
									}
								...
								function j(t, e, n, r) {
									...
									c = o(n);
									if (c) {
										if (i = N(n, r), i === st ? (u = !0, s = i.error, i = null) : a = !0, e === i)
											return void R(e, w())
									} else
										i = r, a = !0;
								...
								function O(t, e) {
									...
									n.promise = new t(v),
									n._validateInput(e) ? (n._input = e, n.length = e.length, n._remaining = e.length, n._init(), 0 === n.length ? A(n.promise, n._result) : (n.length = n.length || 0, n._enumerate(), 0 === n._remaining && A(n.promise, n._result))) : R(n.promise, n._validationError())
								}
								function L(t) {
								...
								function D(t) {
									...
									i = new r(v);
									if (!$(t))
										return R(i, new TypeError("You must pass an array to race.")), i;
								...
								function q(t) {
									...
									this._result = void 0,
									this._subscribers = [],
									v !== t && (o(t) || B(), this instanceof q || M(), k(this, t))
								}
								function U() {
									var t;
								...
								Z = "undefined" != typeof process && "[object process]" === {}
								...
								O.prototype._settledAt = function (t, e, n) {
									var r = this,
									i = r.promise;
									i._state === nt && (r._remaining--, t === it ? R(i, n) : r._result[e] = n),
					...
					function o(t, e) {
						...
						function r(t, e, n) {
							e.ready = i(t.then, t),
							n && Array.isArray(e[n]) && (e[n].forEach(i(t.then, t)), delete e[n])
						}
						var i = n(13);
						t.exports = {
						...
						function i(t, e, n) {
							var s;
							if (e)
								return n = n || e && e.ownerDocument, s = o.isType("function", t) ? t : r(t), e === n ? s(e) ? e : void 0 : s(e) ? e : i(s, e.parentNode, n)
						}
						var o = n(11);
						t.exports = {
							closest: i
						...
						i.prototype.require = function (t) {
							var e = this;
							return t = Array.isArray(t) ? t : s.toRealArray(arguments),
						...
						function c() {
							...
							e = t.reduce(function (e, n, r) {
									...
									o = i && e[i - 1],
									s = r + 1 == t.length;
									return s && n.event_namespace && "batch_log" == n.event_namespace.action && (n.message = ["entries:" + r, "requests:" + i].join("/")),
						...
						function d(t) {
							...
							t.reduce(function (t, e) {
								...
								r = m.stringify(e),
								i = f(r);
								return b + i < g ? t = t.concat(r) : (n = m.splitLogEntry(e), n.length > 1 && (t = t.concat(d(n)))),
								t
							}, [])
						}
						function f(t) {
						...
						function r(t, e) {
							...
							r;
							return e = e || a,
							/^https?:\/\//.test(t) ? t : /^\/\//.test(t) ? e.protocol + t : (n = e.host + (e.port.length ? ":" + e.port : ""), 0 !== t.indexOf("/") && (r = e.pathname.split("/"), r.pop(), r.push(t), t = "/" + r.join("/")), [e.protocol, "//", n, t].join(""))
						}
						function i() {
							for (var t, e = s.getElementsByTagName("link"), n = 0; e[n]; n++)
								if (t = e[n], "canonical" == t.rel)
									return r(t.href)
						}
						function o() {
						...
						function r(t) {
							...
							for (o = {}, t = t || s, e = t.getElementsByTagName("meta"); e[i]; i++)
								n = e[i], /^twitter:/.test(n.name) && (r = n.name.replace(/^twitter:/, ""), o[r] = n.content)
						}
						function i(t) {
							return o[t]
						}
						...
						function r(t, e) {
							var n;
							return e = e || {},
							t && t.nodeType === Node.ELEMENT_NODE ? (n = t.getAttribute("data-scribe"), n && n.split(" ").forEach(function (t) {
									var n = t.trim().split(":"),
									r = n[0],
									i = n[1];
									r && i && !e[r] && (e[r] = i)
						...
						function o(t, e, n) {
							...
							return t = s("tfw_client_event", t, r),
							t.client_version = w,
						...
						function o(t) {
							...
							h.pause(),
							g.load(),
							e = c.allResolved(r(t).map(function (t) {
						...
						r.prototype.add = function (t) {
							...
							this._hasFlushBeenScheduled || (this._hasFlushBeenScheduled = !0, o(s(this._flush, this))),
							e.promise
						},
						...
						function o(t) {
							...
							0 !== t.length && h.isUnbucketed().then(function (s) {
								return s && l.flagUnbucketedScribeItems(t),
								1 === t.length ? r(t) : (e = c(t, function (t) {
						...
						s.aug(i.prototype, {
							...
							build: function (t) {
								var e = this;
								this.Component;
								return s.aug(this.Component.prototype.boundParams, t),
						...
						function i(t, e) {
							return function () {
								...
								s.isPromise(r) ? r.then(function (t) {
						...
						function s() {
							function t(t) {
								...
								this.params = Object.keys(this.paramConfigs).reduce(function (n, s) {
										...
										d = c.validate || r,
										f = c.transform || i;
										if (s in u && a.push(u[s]), s in t && a.push(t[s]), a = "fallback" in c ? a.concat(c.fallback) : a, n[s] = o(a, d, f), c.required && null == n[s])
						...
						function o(t, e, n, i, o) {
							...
							d.src = ["javascript:", 'document.write("");', "try { window.parent.document; }", 'catch (e) { document.domain="' + a.domain + '"; }', "window.parent." + b.fullPath(["sandbox", u]) + "();"].join(""),
						...
						function s(t) {
							...
							t.define("_updateCachedDimensions", function () {
								...
								return c.read(function () {
									var e,
									n = v(t.sandboxEl);
									"visible" == t.sandboxEl.style.visibility ? t._width = n.width : (e = v(t.sandboxEl.parentElement).width, t._width = Math.min(n.width, e)),
									t._height = n.height
								})
							}),
							...
							t.override("insert", function (t, e, n, s) {
								...
								u.promise.then(function (t) {
									...
									w.all([a._setTargetToBlank(), a.addRootClass(A), a.prependCss(R)])
								})
							}),
						...
						function r(t, e, n) {
							function r() {
								...
								c - s > e ? (s = c, void t.apply(a, u)) : void(o = i.setTimeout(function () {
											r.apply(a, u)
										}, e))
							}
							var o,
						...
						t.exports = function () {
							return r || (a.start(d), r = i.request(s.settings()).then(function (t) {
										...
										r = void 0,
										new c(t.is_bucketed, t.should_obtain_cookie_consent)
									}).catch (function (t) {
							...
							function r() {
								...
								return m.ie9() || m.ie10() || "http:" !== d.protocol && "https:" !== d.protocol ? (b.resolve({}), b.promise) : (f.start(w), t = {
										...
										origin: d.origin
											...
											r(),
											f.endAndTrack("load_cookies_timed_out", w, "page", {
									...
									u.body.removeChild(y)
								}, i = function (t) {
									var i;
									if (e.substr(0, t.origin.length) === t.origin)
										try {
											i = c.parse(t.data),
											i && i.namespace === g && (r(i.cookies), clearTimeout(n), f.endAndTrack("load_cookies_success", w, "page", {
													widget_origin: a.rootDocumentLocation(),
													widget_frame: a.isFramed() && a.currentDocumentLocation()
												}))
										} catch (t) {}
							...
							function r() {
								...
								a.aug(t.prototype, {
									...
									select: function (t, e) {
										return 1 === arguments.length && (e = t, t = this.el),
										t ? (e = this.selectors[e] || e, a.toRealArray(t.querySelectorAll(e))) : []
									},
									selectOne: function () {
							...
							function r(t) {
								...
								t.define("scribe", function (t, e, n) {
									t = a.aug(this.scribeNamespace(), t || {}),
									e = a.aug(this.scribeData(), e || {}),
									i.scribe(t, e, !1, n)
								}),
							...
							function r(t) {
								...
								t.define("_updateCachedDimensions", function () {
									...
									return u.read(function () {
										var e,
										n = p(t.sandboxEl);
										"visible" == t.sandboxEl.style.visibility ? t._width = n.width : (e = p(t.sandboxEl.parentElement).width, t._width = Math.min(n.width, e)),
										t._height = n.height
									})
								}),
								t.define("_didResize", function () {
							...
							!function () {
								var e = function (t, n) {
									...
									function o(t, e) {
										...
										p = function () {
											t.offsetWidth == s && t.offsetHeight == a || l(),
											f()
										};
										h(u, "scroll", p),
										h(d, "scroll", p)
							...
							function u(t, e, n, r) {
								t && p.toRealArray(t.querySelectorAll("iframe.autosized-media, .wvp-player-container")).forEach(function (t) {
									...
									r(function () {
										...
										w.present(t, "wvp-player-container") ? (t.style.width = i.width, t.style.height = i.height) : (t.width = i.width, t.height = i.height)
									})
								})
							}
							function c(t, e, n, r) {
							...
							function i(t) {
								return (t || "").split(";").reduce(function (t, e) {
									var n,
									i;
									return c.test(e.trim()) && (n = RegExp.$1, i = RegExp.$2, t[r(n)] = i),
									t
								}, {})
							}
							function o(t) {
							...
							function r(t, e, n, r, i) {
								...
								c = a(t, n, r, i);
								if (c)
									return (o = d.createPlayerForTweet(c.element, e, c.options)) ? (s.resolve(o), s.promise) : s.reject(new Error("unable to create tweet video player"))
							}
							...
							function a(t, e, n, r) {
								...
								if (r = r || {}, o = {
									...
									}, i = c(t, ".wvp-player-container"), i.length > 0)
							...
							function r(t, e) {
								...
								t.ownerDocument !== i && e.sandboxEl && (a = e.sandboxEl.getBoundingClientRect(), s = {
										top: s.top + a.top,
							...
							function r(t) {
								...
								t.define("setWrapperSize", function (t, e) {
									...
									s = u * r + "px";
									return i.write(function () {
										n._constrainingWrapper.style.maxWidth = s,
							...
							a.addEventListener && a.addEventListener("DOMContentLoaded", o = function () {
								a.removeEventListener("DOMContentLoaded", o, f),
								r()
							}, f),
							l.doScroll && a.attachEvent("onreadystatechange", i = function () {
